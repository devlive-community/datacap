  ...
  <a-modal v-model:visible="visible" :title="title" width="60%">
    <a-form :model="formState" :validate-messages="validateMessages"
      ...
      <a-tabs v-model:activeKey="activeKey">
        <a-tab-pane key="type">
          <template #tab>
            <span><appstore-outlined/> Type </span>
          </template>
        ...
        <a-tab-pane :disabled="!formState.type" key="configure">
          <template #tab>
            <span><setting-outlined/> Configure </span>
          </template>
        ...
        <a-tab-pane :disabled="!formState.type" key="authorization">
          <template #tab>
            <span><lock-outlined/> Authorization </span>
          </template>
        ...
        <a-tab-pane :disabled="!formState.type" key="advanced">
          <template #tab>
            <span><group-outlined/> Advanced </span>
          </template>
      ...
      <a-form-item :wrapper-col="{ ...layout.wrapperCol, offset: 8 }">
        <a-space style="width: 100%">
          ...
          <a-button key="submit" type="primary" size="small" html-type="submit">Save</a-button>
        </a-space>
      </a-form-item>
    </a-form>
