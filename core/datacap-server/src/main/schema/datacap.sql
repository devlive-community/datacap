...
--       Update to 1.10.0        --
-- --------------------------------
INSERT INTO datacap.template_sql(name, content, description, plugin, configure, `system`)
...
GROUP BY
  table_type', 'Finds all table types under the database according to the database', 'H2,MySQL', '[{"column":"database","type":"String","expression":"${database:String}"}]', TRUE),
...
GROUP BY
  TABLE_NAME,
  TABLE_CATALOG', 'Gets a collection of related data based on the specified database and data type', 'H2,MySQL',
