...
import { ArrowLeft, ArrowLeftToLine, ArrowRight, ArrowRightToLine, Cog, Plus } from 'lucide-vue-next'
...
export default defineComponent({
  ...
  components: {
    ...
    ArrowLeftToLine, ArrowLeft, ArrowRight, ArrowRightToLine, Cog, Plus
  },
  props: {
    info: {
