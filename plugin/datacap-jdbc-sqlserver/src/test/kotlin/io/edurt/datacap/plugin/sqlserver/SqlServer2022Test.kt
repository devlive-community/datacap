...
class SqlServer2022Test {
    private val log = getLogger(this.javaClass)

    private val host = "TestSqlServerContainer"
    ...
    fun before() {
        ...
        log.info("SQL Server 2022 container started")
    ...
    @Test
    fun test() {
        configure!!.version = Optional.of(SqlServerVersion.V2022.version)
