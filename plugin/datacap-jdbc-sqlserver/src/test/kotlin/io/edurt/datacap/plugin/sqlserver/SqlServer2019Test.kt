...
class SqlServer2019Test {
    private val log = getLogger(this.javaClass)

    private val host = "TestSqlServer2019Container"
    ...
    fun before() {
        ...
        log.info("SQL Server 2019 container started")
    ...
    @Test
    fun test() {
        configure!!.version = Optional.of(SqlServerVersion.V2019.version)
